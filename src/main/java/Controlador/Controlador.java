                        ...
                        if (proP.getCantidad() < can) {
                            ...
                            if (tipo.getSuscripcion() == 2) {
                                ...
                                try {
                                    ...
                                    String orden = repoPedido.hacerPedido(fabrica1.getDominio(), fabrica1.getUsuario(),
                                            fabrica1.getPass(), pro.getNombre(), credito);
        ...
        if (menu.equals("Inventario")) {
            switch (accion) {
                ...
                case "Editar":
                    ...
                    request.getRequestDispatcher("Controlador?menu=Inventario&accion=Listar").forward(request,
                            response);
                    break;
                case "Actualizar":
        ...
        if (menu.equals("Pedido")) {
            switch (accion) {
                ...
                case "Listar Inventario":
                    ...
                    try {
                        request.setAttribute("modelos",
                                new PedidoRepository().inventarioFabrica(f.getDominio(), f.getUsuario(), f.getPass()));
                    } catch (Exception e) {
                        e.printStackTrace();
                    }
                    ...
                    try {
                        ...
                        if (prod.getId() == 0) {
                            ...
                            if (mdao.buscarM(nuevo.getMarca()).getId() == 0) {
                                ...
                                mr.setLogo(
                                        "https://www.google.com/url?sa=i&url=https%3A%2F%2Fwww.designevo.com%2Fes%2Fcreate%2Flogos%2Fphone.html&psig=AOvVaw1LEFaP9f6nmeh45igVZ2Qp&ust=1619842825037000&source=images&cd=vfe&ved=0CAIQjRxqFwoTCIDCyPSOpfACFQAAAAAdAAAAABAJ");
                        ...
                        String orden = repoPedido.hacerPedido(fabrica1.getDominio(), fabrica1.getUsuario(),
                                fabrica1.getPass(), modelo, cantidad);
                        boolean envio = true;
